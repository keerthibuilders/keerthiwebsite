...
import  ChartDollarIcon from '../../../../public/assets/images/chart-mixed-up-circle-dollar.svg';
const SmartLandInvestment = () => {
  const benefits = [
    {
      icon: ChartDollarIcon,
      ...
      <div style={styles.container}>
        ...
        <div style={styles.left}>
          <h2 style={styles.title}>
            Smart Land Investment with Assured Returns
          </h2>
          <p style={styles.subtitle}>
            Secure early access to a BDA-approved land development project near
            Mysore Road with just ₹5 Lakhs. Enjoy 15% assured returns in 12
            months, early-bird pricing, refundable token, and priority plot
            selection — all with zero pressure to commit immediately.
          </p>
          ...
          <div style={styles.buttonGroup}>
            ...
            <button style={{ ...styles.button, ...styles.filled }}>
              Contact us
            </button>
          </div>
        </div>
